...
export default function Navbar() {
  ...
  const isLight = false; // Luôn dùng dark theme để đồng bộ
  ...
  return (
    <header className={`sticky top-0 z-50 backdrop-blur-xl border-b ${isLight ? 'bg-white/80 border-slate-200' : 'bg-slate-950/80 border-slate-800/50 shadow-xl'}`}>
          ...
          {user ? (
            <>
              ...
              <button
                ...
                className={`relative p-2 rounded-xl border transition-all group shadow-lg ${isLight
              ...
              <button
                ...
                className={`relative p-2 rounded-xl border transition-all group shadow-lg ${isBubbleOpen
              ...
              <div className="relative" ref={profileRef}>
                <button
                  ...
                  className={`flex items-center gap-2.5 px-3 py-1.5 rounded-2xl border transition-all focus:outline-none shadow-lg group ${isLight ? 'bg-slate-100 hover:bg-slate-200' : 'bg-slate-800/80 hover:bg-slate-700/80'
                    } ${isProfileOpen ?
                ...
                >
                  <UserAvatar
                    user={user}
                    size="sm"
                    className={`w-8 h-8 rounded-full border-none shadow-amber-500/20 ${user.role_id === 3 ? 'bg-linear-to-tr from-amber-500 to-orange-500 shadow-amber-500/20' :
                  ...
                  <div className="hidden sm:flex flex-col items-start leading-tight pr-1">
                    ...
                    <span className={`text-[10px] font-black uppercase tracking-wider px-1.5 py-0.25 rounded-md mt-0.5 ${user.role_id === 3 ? 'bg-amber-500/20 text-amber-400' :
                    ...
                    <div className="p-4 border-b border-slate-700 bg-slate-800/50">
                      <div className="flex items-center gap-3">
                        <UserAvatar
                          user={user}
                          size="md"
                          className={`w-10 h-10 rounded-full border-none ${user.role_id === 3 ? 'bg-linear-to-br from-amber-500 to-orange-500 shadow-amber-500/20' :
