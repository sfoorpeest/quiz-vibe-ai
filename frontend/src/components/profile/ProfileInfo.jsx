...
const fieldCardClass = 'rounded-2xl border border-slate-700/60 bg-slate-950/40 p-4 transition-all hover:bg-slate-900/60 hover:border-blue-500/30 group';
const editLabelClass = 'text-slate-100 font-bold tracking-wide transition-colors';
const editInputClass = '!border-slate-700 !bg-slate-950 px-4 py-3 text-slate-100 placeholder:text-slate-400 focus:!border-blue-500 caret-blue-400 selection:bg-blue-500/30';
const selectClass = 'profile-gender-select w-full rounded-2xl border-2 border-slate-700 bg-slate-900/50 px-4 py-3.5 text-sm transition-all duration-300 focus:border-blue-500/50 focus:bg-slate-900/80 focus:outline-none caret-blue-400';
        ...
        <div className="space-y-5">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Input
              ...
              labelClassName={editLabelClass}
              className={`${editInputClass} profile-date-input`}
            />
            <div>
