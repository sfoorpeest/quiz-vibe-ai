...
const textareaClass = 'min-h-32 w-full rounded-2xl border border-slate-500 bg-slate-950/50 px-4 py-3 text-sm text-slate-100 placeholder:text-slate-400 focus:border-blue-500 focus:outline-none caret-blue-300 selection:bg-blue-500/30';
